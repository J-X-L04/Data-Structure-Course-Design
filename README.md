...
### 1、项目介绍：
《溯源者：文明环境》是一款国风题材、类《SlayTheSpire》的 Roguelike 卡牌单机：玩家在层状地图上选择路线，进入战斗、事件、商店、休息、宝箱等节点，通过组牌、能量与资源管理推进层数直至 Boss。静态内容（卡牌、怪物、事件等）由 data/ 下 JSON 等表驱动；程序负责地图、战斗流程、牌堆、事件脚本与存档。玩法大部分参考《SlayTheSpire》。

### 2、项目主要功能：

#### (1) 《溯源者：文明环境》项目分析PDF：
[点击此处查看或下载项目分析PPT](./《溯源者：文明环境》项目分析.pdf)
...
### 1、项目介绍：
《凌空墨迹 SpiritInk》是一款非接触式虚拟书法交互系统。用户面对笔记本前置摄像头，通过手势在空中书写汉字——系统实时捕获指尖 2D 轨迹并叠加 AR 笔迹效果于摄像头画面上，同时利用 DTW (动态时间规整) 与 Trie 字典树 完成对 3000+ 常用汉字的拓扑匹配，并从多维度给出书法评价与反馈。

### 2、项目主要功能：

#### (1) 《凌空墨迹 SpiritInk》项目主要功能截图：
<img width="1269" height="804" alt="《凌空墨迹 SpiritInk》项目主要功能截图" src="https://github.com/user-attachments/assets/ca6a4513-05a5-4237-bd46-377156dc33fd" />

#### (2) 《凌空墨迹 SpiritInk》项目展示视频：
...
### 2、项目主要功能：
Satori 以“焚香”为核心专注仪式，把计时、白噪音、器乐、复盘和统计收拢在一个安静的使用流程里。用户可以离线使用基础功能，也可以在配置 Supabase 后开启账号登录与云端行迹同步。主要包括以下功能：

#### （1）焚香专注：倒计时、正计时、预设时长、自定义时长、暂停、放弃、手动完成与结束小结。
<center><img width="509" height="1138" alt="focus_page1" src="https://github.com/user-attachments/assets/f21b5583-22ca-4ae3-90ad-b04b3f69288b" /></center>

#### （2）复盘记录：任务标签、小结备注、完成感受、短时专注过滤和本地历史记录。
<center><img width="510" height="1135" alt="history_page1" src="https://github.com/user-attachments/assets/3fa4a9e6-f4d6-4f34-aae7-d06ca9b0d0b" /></center>

<center><img width="508" height="1137" alt="history_page2" src="https://github.com/user-attachments/assets/07f03f06-37c4-4f0e-9e0c-0b2a03604b86" /></center>

<center><img width="506" height="1135" alt="history_page3" src="https://github.com/user-attachments/assets/c4f392fd-230a-41b9-9a0a-34da1f6abe9c" /></center>

<center><img width="506" height="1133" alt="hiatory_page4" src="https://github.com/user-attachments/assets/41388cbc-8614-4a61-b552-e3563c0170b2" /></center>

#### （3）听雨与抚琴：白噪音、器乐播放、音量控制和会员权益锁定展示。
<center><img width="509" height="1136" alt="music_page" src="https://github.com/user-attachments/assets/e8e49d18-b34d-43d9-acbc-f2fc9362321f" /></center>

<center><img width="510" height="1138" alt="white_noise_page" src="https://github.com/user-attachments/assets/68bff44d-d211-4e5b-bd0f-759cc6e44678" /></center>
...
### 3、项目仓库：
[点击访问 Tracer-Civilization-Environment 仓库](https://github.com/Kahiy314/Satori)
